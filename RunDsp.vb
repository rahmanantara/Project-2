...
Public Class RunDSP
    ...
    Public Shared Sub myDSPCalc(ByRef DSPWs_As_DspWave As Object, ByRef DSPWc_As_DspWave As Object,  _
		ByRef MeanCalcValue_As_SiteDouble As Object, ByRef MaxCalcValue_As_SiteDouble As Object,  _
		ByRef MinCalcValue_As_SiteDouble As Object, ByVal NumberSamples_As_SiteLong As Object,  _
		ByRef CalcSlopeValue_As_SiteDouble As Object, ByRef RMS_Value_As_SiteDouble As Object,  _
		ByRef Histogram_As_DspWave As Object)
        RunDspProcedure("myDSPCalc", New DspByRef(DSPWs_As_DspWave), New DspByRef(DSPWc_As_DspWave), New DspByRef(MeanCalcValue_As_SiteDouble),  _
		New DspByRef(MaxCalcValue_As_SiteDouble), New DspByRef(MinCalcValue_As_SiteDouble),  _
		NumberSamples_As_SiteLong, New DspByRef(CalcSlopeValue_As_SiteDouble), New DspByRef(RMS_Value_As_SiteDouble),  _
		New DspByRef(Histogram_As_DspWave))
    End Sub
End Class
